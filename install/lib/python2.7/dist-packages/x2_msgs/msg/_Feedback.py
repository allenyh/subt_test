...
"""autogenerated by genpy from x2_msgs/Feedback.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','x2_msgs/DriveFeedback[2]','float32','float32','int8','int8']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.drivers is None:
        self.drivers = [x2_msgs.msg.DriveFeedback() for _ in range(2)]
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.drivers = []
      for i in range(0, 2):
        val1 = x2_msgs.msg.DriveFeedback()
        _x = val1
        start = end
        end += 25
