...
(cl:defclass <Feedback> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (drivers
    :reader drivers
    :initarg :drivers
    :type (cl:vector x2_msgs-msg:DriveFeedback)
   :initform (cl:make-array 2 :element-type 'x2_msgs-msg:DriveFeedback :initial-element (cl:make-instance 'x2_msgs-msg:DriveFeedback)))
   (pcb_temperature
...
(cl:defmethod cl:initialize-instance :after ((m <Feedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Feedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name x2_msgs-msg:<Feedback> is deprecated: use x2_msgs-msg:Feedback instead.")))
...
(cl:defmethod drivers-val ((m <Feedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader x2_msgs-msg:drivers-val is deprecated.  Use x2_msgs-msg:drivers instead.")
  (drivers m))

(cl:ensure-generic-function 'pcb_temperature-val :lambda-list '(m))
(cl:defmethod pcb_temperature-val ((m <Feedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader x2_msgs-msg:pcb_temperature-val is deprecated.  Use x2_msgs-msg:pcb_temperature instead.")
  (pcb_temperature m))

(cl:ensure-generic-function 'mcu_temperature-val :lambda-list '(m))
(cl:defmethod mcu_temperature-val ((m <Feedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader x2_msgs-msg:mcu_temperature-val is deprecated.  Use x2_msgs-msg:mcu_temperature instead.")
  (mcu_temperature m))

(cl:ensure-generic-function 'commanded_mode-val :lambda-list '(m))
(cl:defmethod commanded_mode-val ((m <Feedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader x2_msgs-msg:commanded_mode-val is deprecated.  Use x2_msgs-msg:commanded_mode instead.")
  (commanded_mode m))

(cl:ensure-generic-function 'actual_mode-val :lambda-list '(m))
(cl:defmethod actual_mode-val ((m <Feedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader x2_msgs-msg:actual_mode-val is deprecated.  Use x2_msgs-msg:actual_mode instead.")
  (actual_mode m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Feedback>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'drivers)))
    (cl:dotimes (i 2)
    (cl:setf (cl:aref vals i) (cl:make-instance 'x2_msgs-msg:DriveFeedback))
