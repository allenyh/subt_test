...
if("FALSE" STREQUAL "TRUE")
  set(multimaster_msgs_fkie_SOURCE_PREFIX /home/developer/clearpath_ws/src/multimaster_fkie/multimaster_msgs_fkie)
  set(multimaster_msgs_fkie_DEVEL_PREFIX /home/developer/clearpath_ws/devel)
  ...
  set(multimaster_msgs_fkie_INSTALL_PREFIX /home/developer/clearpath_ws/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multimaster_msgs_fkie' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/developer/clearpath_ws/install/${idir}'.  ${_report}")
    endif()
