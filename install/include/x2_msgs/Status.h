// Generated by gencpp from file x2_msgs/Status.msg
// DO NOT EDIT!


#ifndef X2_MSGS_MESSAGE_STATUS_H
#define X2_MSGS_MESSAGE_STATUS_H
...
struct Status_
{
  ...
  typedef boost::shared_ptr< ::x2_msgs::Status_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::x2_msgs::Status_<ContainerAllocator> const> ConstPtr;

}; // struct Status_

typedef ::x2_msgs::Status_<std::allocator<void> > Status;

typedef boost::shared_ptr< ::x2_msgs::Status > StatusPtr;
typedef boost::shared_ptr< ::x2_msgs::Status const> StatusConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::x2_msgs::Status_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::x2_msgs::Status_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::x2_msgs::Status_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::x2_msgs::Status_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::x2_msgs::Status_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::x2_msgs::Status_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::x2_msgs::Status_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::x2_msgs::Status_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::x2_msgs::Status_<ContainerAllocator> >
{
  ...
  static const char* value(const ::x2_msgs::Status_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xc851ebcf9a6e20b1ULL;
  static const uint64_t static_value2 = 0x96bc7894e285b4f6ULL;
};

template<class ContainerAllocator>
struct DataType< ::x2_msgs::Status_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::x2_msgs::Status_<ContainerAllocator> >
{
  static const char* value()
  {
    return "# This message represents X2's lower-frequency status updates\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::x2_msgs::Status_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::x2_msgs::Status_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::x2_msgs::Status_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // X2_MSGS_MESSAGE_STATUS_H
