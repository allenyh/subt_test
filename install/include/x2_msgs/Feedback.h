// Generated by gencpp from file x2_msgs/Feedback.msg
// DO NOT EDIT!


#ifndef X2_MSGS_MESSAGE_FEEDBACK_H
#define X2_MSGS_MESSAGE_FEEDBACK_H
...
#include <x2_msgs/DriveFeedback.h>
...
struct Feedback_
{
  ...
  Feedback_(const ContainerAllocator& _alloc)
    ...
    , actual_mode(0)  {
  (void)_alloc;
      drivers.assign( ::x2_msgs::DriveFeedback_<ContainerAllocator> (_alloc));
  }
  ...
  _header_type header;
   ...
   typedef boost::array< ::x2_msgs::DriveFeedback_<ContainerAllocator> , 2>  _drivers_type;
  ...
  typedef boost::shared_ptr< ::x2_msgs::Feedback_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::x2_msgs::Feedback_<ContainerAllocator> const> ConstPtr;

}; // struct Feedback_

typedef ::x2_msgs::Feedback_<std::allocator<void> > Feedback;

typedef boost::shared_ptr< ::x2_msgs::Feedback > FeedbackPtr;
typedef boost::shared_ptr< ::x2_msgs::Feedback const> FeedbackConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::x2_msgs::Feedback_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::x2_msgs::Feedback_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::x2_msgs::Feedback_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::x2_msgs::Feedback_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::x2_msgs::Feedback_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::x2_msgs::Feedback_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::x2_msgs::Feedback_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::x2_msgs::Feedback_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::x2_msgs::Feedback_<ContainerAllocator> >
{
  ...
  static const char* value(const ::x2_msgs::Feedback_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3bdabb0ef46338eeULL;
  static const uint64_t static_value2 = 0x5672d1b82220ab49ULL;
};

template<class ContainerAllocator>
struct DataType< ::x2_msgs::Feedback_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::x2_msgs::Feedback_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::x2_msgs::Feedback_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::x2_msgs::Feedback_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::x2_msgs::Feedback_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    for (size_t i = 0; i < v.drivers.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::x2_msgs::DriveFeedback_<ContainerAllocator> >::stream(s, indent + "    ", v.drivers[i]);
    }
...
#endif // X2_MSGS_MESSAGE_FEEDBACK_H
